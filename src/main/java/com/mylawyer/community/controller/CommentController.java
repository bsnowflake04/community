...
public class CommentController {
    ...
    public ResultDTO<List<CommentsDTO>> comments(@PathVariable(name = "id") Long id) {
        List<CommentsDTO> commentsDTOS = commentService.listByTargetId(id, CommentTypeEnum.COMMENT);
